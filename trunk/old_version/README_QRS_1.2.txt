Quantification of Representative Sequences (QRS) pipeline v. 1.2.0
------------------------------------------------------------------
...
Before executing this part, you have to evaluate the characteristics of your data set according to the previous step (see AM1 section). As all NGS data sets are different depending on the case study, there are no default parameters to filter and trim sequences according to length, quality and complexity. 
